...
const Diary = () => {
    ...
    try {
      if (selectedEntry !== null) {
        ...
        const updatedEntry = {
          ...
          title,
          content,
          createdAt: new Date(currentDate).toISOString(), // 날짜를SO 형식으로 변환
        };
  ...
  const handleEditEntry = () => {
    ...
    setCurrentDate(
      new Date(diaryEntries[selectedEntry].createdAt).toLocaleDateString()
    );
    ...
    <div className="min-h-screen p-12 bg-gray-100">
      <div className="w-5/6 h-[90vh] p-8 mx-auto bg-white rounded-lg shadow-lg">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2
            className="w-full mb-6 font-poppins font-normal text-[24px] leading-[36px] text-left"
            style={{ color: '#379AE6' }}>
            Diary
          </h2>
        </div>
